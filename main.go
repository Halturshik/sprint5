...
// TrainingInfo  TrainingInfo() InfoMessage {
// вставьте возвращает труктуру InfoMessage, в которой хранится вся информация о проведенной тренировке.
...
func (r Running) TrainingInfo() InfoMessage {
	information := r.Training.TrainingInfo()
	information.Calories = r.Calories()
	return information
}
...
func (w Walking) Calories() float64 {
	...
	speedSquare := math.Pow(meanSpeedInMsec, 2)
	heightInMeters := w.Height / 100
	return ((CaloriesWeightMultiplier*w.Weight + (speedSquare/heightInMeters)*
...
func (w Walking) TrainingInfo() InfoMessage {
	information := w.Training.TrainingInfo()
	information.Calories = w.Calories()
	return information
}
...
func (s Swimming) TrainingInfo() InfoMessage {
	information := s.Training.TrainingInfo()
	information.Calories = s.Calories()
	information.Speed = s.meanSpeed()
	information.Distance = s.distance()
	return information
}
